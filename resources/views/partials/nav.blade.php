...
{{--                    <img class="block lg:hidden h-8 w-auto" src="https://tailwindui.com/img/logos/workflow-mark-indigo-500.svg" alt="Workflow">--}}
                ...
                <div class="hidden sm:block sm:ml-6">
                    <div class="flex space-x-4">
                        ...
                        <a href="#contact" class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Kapcsolat</a>
                    </div>
                </div>
            </div>
...
{{--                            <a href="{{ route('dashboard') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem" tabindex="-1" id="user-menu-item-0">Your Profile</a>--}}
    ...
    <div class="sm:hidden" id="mobile-menu" x-show="mobile" @click.outside="mobile = false">
        <div class="px-2 pt-2 pb-3 space-y-1">
            ...
            <a href="#contact" class="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">Kapcsolat</a>
            @auth()
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
